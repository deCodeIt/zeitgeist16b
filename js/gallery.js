	...
	$(".galimage").click(function() {
        ...
        switch(a)
        {
            case '1': $('.fillleft').css('background-color','rgba(60,55,50,0.7)');
                    ...
                    break;
            case '2': $('.fillleft').css('background-color','rgba(50,50,50,0.7)');
                    $('.fillright').css('background-color','rgba(50,50,50,0.7)');
                    break;
            case '3': $('.fillleft').css('background-color','rgba(50,50,50,0.7)');
                    $('.fillright').css('background-color','rgba(50,50,50,0.7)');
                    break;
            case '4': $('.fillleft').css('background-color','rgba(50,50,50,0.7)');
                    $('.fillright').css('background-color','rgba(50,50,50,0.7)');
                    break;
            case '5': $('.fillleft').css('background-color','rgba(50,50,50,0.7)');
                    $('.fillright').css('background-color','rgba(50,50,50,0.7)');
                    break;
            case '6': $('.fillleft').css('background-color','rgba(50,50,50,0.7)');
                    $('.fillright').css('background-color','rgba(50,50,50,0.7)');
                    break;
